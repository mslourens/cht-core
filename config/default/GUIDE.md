...
You should have the [Core Framework running](../../INSTALL.md), have installed [cht-conf](https://github.com/medic/cht-conf) and have checked out or otherwise downloaded the [Reference Application](./).
